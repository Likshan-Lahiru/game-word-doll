            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#1F2937]/95">
                <div className="flex flex-col items-center">
                    <div className="bg-[#3F4C5F] rounded-2xl p-6 text-center text-white w-[320px]">
                        ...
                        <p className="mb-4 font-bold">and</p>
                        <p className="flex items-center justify-center mb-4">
                            <span className="mr-2 font-bold">Win</span>
                            <img
                                src="https://uploadthingy.s3.us-west-1.amazonaws.com/agrcZVSRX593jbti3xzVTM/heart.png"
                                alt="Coins"
                                className="w-6 h-6"
                            />
                            <span className="ml-2  font-bold">Gems</span>
                        </p>
                    </div>
                    <div className="mt-6">
                        <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#1F2937]/95">
            <div className="w-full max-w-md mx-auto">
                <div className="bg-[#3F4C5F] rounded-xl p-8 text-center text-white">
                    ...
                    <button
                        className="w-60 bg-[#3B82F6] hover:bg-blue-600 text-white font-bold py-3 px-4 rounded-2xl mb-6"
                        onClick={handleSignUp}
                    >
                        Sign Up Now
                    </button>
                ...
                <div className="mt-4 flex justify-center">
                    <button
                        className="bg-[#374151] hover:bg-[#2D3748] text-white font-bold py-3 px-8 rounded-2xl"
                        onClick={handleNoThanks}
                    >
                        No, Thanks
                    </button>
