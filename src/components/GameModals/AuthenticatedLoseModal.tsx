...
type AuthenticatedLoseModalProps = {
    isOpen: boolean
    onClose: () => void
    penalty: number
}
export function AuthenticatedLoseModal({
                                           isOpen,
                                           onClose,
                                           penalty,
                                       }: AuthenticatedLoseModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#1F2937]">
            <div className="bg-[#374151] rounded-2xl p-6 text-center text-white w-[320px] flex flex-col items-center">
                <h2 className="text-3xl text-[#FFFFFF] font-semibold mt-10 mb-24 font-[Inter]">Time Ended !</h2>
