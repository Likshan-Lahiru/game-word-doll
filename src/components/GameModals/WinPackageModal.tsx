...
export function WinPackageModal({
                                    isOpen,
                                    onClose,
                                    prize,
        ...
        if (isOpen && fireworksRef.current) {
            ...
            const launchFireworks = () => {
                ...
                const interval = setInterval(() => {
                    ...
                    // Colorful fireworks from different positions
                    confetti({
                        ...defaults,
                        particleCount,
                        origin: {
                    ...
                    // Add occasional confetti cannons from corners
                    if (Math.random() < 0.3) {
                        confetti({
                            particleCount: 40,
    ...
    return (
        ...
        >
            ...
            x {prize.spinAmount} free
                ...
                <button
                    className="bg-[#3B82F6] hover:bg-blue-600 text-white py-4 px-16 rounded-xl text-3xl font-medium w-full"
