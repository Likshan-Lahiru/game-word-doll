...
export function StatusBar({
    ...
    return (
        <div className="pt-2 pr-6 pl-2 sm:pt-2 sm:pr-6 sm:pl-2 flex flex-col sm:flex-row sm:justify-between">
            {isMobile ? (
                <>
                ...
                <>
                    ...
                    <div className="flex flex-col space-y-1 mt-5">
                        <div className="w-50 h-12 bg-[#0A0E1A] rounded-full flex items-center px-3 space-x-4 outline outline-2 outline-[#374151] mt-1 mb-1">
                            <div className="w-6 h-7 mr-2 ml-1 flex items-center justify-center">
                                <img
                                    src="https://uploadthingy.s3.us-west-1.amazonaws.com/agrcZVSRX593jbti3xzVTM/heart.png"
                                    alt="Heart"
                ...
                {Number.isInteger(gemBalance) ? gemBalance : gemBalance.toFixed(2)}
              </span>
                        </div>
                        <div className="w-48 h-12 bg-[#0A0E1A] rounded-full flex items-center px-1 space-x-2 outline outline-2 outline-[#374151]">
                            <div className="w-12 h-10 ml-1 flex items-center justify-center">
                                <img
                                    src="https://uploadthingy.s3.us-west-1.amazonaws.com/uwPYNNRiavmZZ285SkzD5Z/diaomnd.png"
                                    alt="Diamond"
                            ...
                            <span className="ml-1 text-lg font-Inter font-bold">
                {Number.isInteger(voucherBalance) ? voucherBalance : voucherBalance.toFixed(2)}
              </span>
                        </div>
                    </div>
                </>
