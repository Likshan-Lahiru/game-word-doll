            ...
            {isMobile ? (
                <>
                    ...
                    <div className="flex justify-center space-x-3 mb-2">
                        <div
                            className="w-36 h-10 bg-[#111827] rounded-full flex items-center px-4  ">{/*outline outline-1 outline-[#374151]*/}
                ...
                <>
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="text-2 font-Inter font-semibold">1,568 Online</span>
                    </div>
