...
export const TimeEndedModal = ({isOpen}: ModalProps) => {
        ...
        <>
            <div className="fixed inset-0 z-50 flex items-center justify-center font-inter bg-[#1F2937E5]/80">
                <div className="flex-col flex justify-between relative bg-[#374151] rounded-2xl shadow-xl lg:h-[85vh] md:h-[85vh] h-[72vh] lg:w-1/4 md:w-1/3 w-2/3 text-center font-['DM_Sans']">
                    <div>
                        <p className={`lg:text-[30px] md:text-[28px] text-[23px] font-bold mt-10 mb-5 text-[#FE5C5C]`}>Time Ended !</p>
                    </div>

                    <div className={`flex flex-col gap-y-5 justify-center text-white font-bold`}>
                        <p className="text-white text-[20px] font-bold text-center font-['DM_Sans']">Claim your entry</p>
