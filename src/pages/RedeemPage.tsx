  ...
  if (isMobile) {
    return <div className="flex flex-col w-full min-h-screen bg-[#1F2937] text-white">
        ...
        <div className="flex px-6 mb-8">
          <button className={`flex-1 py-4 px-4 rounded-2xl flex items-center justify-center space-x-2 ${activeTab === 'coins' ? 'bg-blue-500' : 'bg-[#131520]'}`} onClick={() => {
          setActiveTab('coins');
          navigate('/store');
        }}>
            <span className="font-bold text-sm">Get Gold Coins</span>
            <img src="/gold-store.png" alt="Coins" className="w-7 h-7" />
          </button>
          <div className="w-4"></div>
          <button className={`flex-1 py-4 px-4 rounded-2xl flex items-center justify-center space-x-2 ${activeTab === 'redeem' ? 'bg-blue-500' : 'bg-[#131520]'}`} onClick={() => setActiveTab('redeem')}>
            <span className="font-bold text-sm">Redeem</span>
            <img src="/redeem.png" alt="Redeem" className="w-7 h-7" />
          </button>
        </div>
        {/* Withdraw section */}
          ...
          <div className="mb-4">
            <div className="flex items-center mb-3">
              ...
              <div className="w-24 bg-white rounded-md px-4 py-2 flex justify-between mx-2">
                <input type="number" value={redeemAmount} onChange={e => setRedeemAmount(Number(e.target.value))} className="bg-transparent w-16 outline-none text-black text-sm" />
              </div>
            ...
            <div className="flex justify-center mt-5">
              <button onClick={handleRedeemNow} className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-10 rounded-full font-medium text-sm w-auto">
                Transfer Now
              </button>
            </div>
          </div>
        ...
        <div className="px-6 mb-8">
          ...
          <div className="flex justify-center">
            <button onClick={handleAddBankAccount} className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-8 rounded-full font-medium text-sm">
              Add Bank Account
            </button>
          </div>
        </div>
        ...
        {showTransferModal && <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
            <div className="bg-gray-800 rounded-xl p-6 w-full max-w-md">
              ...
              <div className="flex space-x-4">
                <button onClick={() => setShowTransferModal(false)} className="flex-1 bg-white text-gray-800 py-2 px-4 rounded-full font-medium">
                  Cancel
                </button>
                <button onClick={handleConfirmTransaction} className="flex-1 bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-full font-medium">
                  Confirm Transaction
                </button>
              </div>
            </div>
        ...
        {showCompletedModal && <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
            <div className="bg-gray-800 rounded-xl p-6 w-full max-w-md">
              ...
              <div className="flex justify-center">
                <button onClick={handleDone} className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-8 rounded-full font-medium">
                  Done
                </button>
              </div>
            </div>
  ...
  return <div className="flex flex-col w-full min-h-screen bg-[#1F2937] text-white">
      ...
      <div className="flex flex-1 px-20 pb-8">
        ...
        <div className="w-72 bg-[#374151] rounded-xl p-6 mr-8">
          ...
          <button className="w-full bg-[#1F2937] hover:bg-gray-700 text-white py-4 px-5 rounded-xl mb-4 flex items-center" onClick={() => navigate('/store')}>
            <span className="flex-1 text-left ml-2 font-medium">
              Get Gold Coins
            </span>
            <div className="w-12 h-12 flex items-center justify-center">
              <img src="/gold-store.png" alt="Coins" className="w-10 h-10" />
            </div>
          </button>
          <button className="w-full bg-blue-500 hover:bg-blue-600 text-white py-4 px-5 rounded-xl flex items-center" onClick={() => {}}>
            <span className="flex-1 text-left ml-2 font-medium">Redeem</span>
            <div className="w-12 h-12 flex items-center justify-center">
              <img src="/redeem.png" alt="Redeem" className="w-10 h-10" />
            </div>
          </button>
        </div>
        ...
        <div className="flex-1 bg-[#374151] rounded-xl p-10">
          ...
          <div className="flex items-center mb-8">
            ...
            <div className="bg-white rounded-md px-4 py-2 flex items-center">
              <input type="number" value={redeemAmount} onChange={e => setRedeemAmount(Number(e.target.value))} className="bg-transparent w-16 outline-none text-black text-lg" />
              <span className="text-gray-500 ml-1">({`$${redeemAmount}`})</span>
            </div>
            <p className="text-white ml-4">gems to cash ($1 per gem)</p>
            <div className="flex-1 flex justify-end">
              <button onClick={handleRedeemNow} className="bg-[#4299e1] hover:bg-blue-600 text-white py-2 px-10 rounded-full font-medium">
                Redeem Now
              </button>
            </div>
          </div>
          ...
          <div className="flex items-center mb-12">
            ...
            <div className="flex-1 flex justify-end">
              <button onClick={handleAddBankAccount} className="bg-[#4299e1] hover:bg-blue-600 text-white py-2 px-8 rounded-full font-medium">
                Add Bank Account
              </button>
            </div>
          </div>
