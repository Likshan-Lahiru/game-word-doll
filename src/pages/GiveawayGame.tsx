        ...
        <div className="flex-1 flex flex-col items-center justify-start px-4 pt-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 w-full max-w-5xl mb-8">
            ...
            <div className="bg-white rounded-xl p-4 text-black flex flex-col items-center w-[190px] h-[400px]">
              ...
              <img
                  src="https://uploadthingy.s3.us-west-1.amazonaws.com/5sNDV16zKDrZv4WE8wxPR4/prizez-coins-1.png"
                  alt="Coins"
            ...
            <div className="bg-white rounded-xl p-4 text-black flex flex-col items-center w-[190px] h-[400px]">
              <p className="font-bold text-lg mb-2">Win</p>
              <img
                  src="https://uploadthingy.s3.us-west-1.amazonaws.com/xhwr6vr8mJJCTeAgmtWgrD/prizez-coins-2.png"
                  alt="Coins"
                  className="w-16 h-16 mb-3"
              />
            ...
            <div className="bg-white rounded-xl p-4 text-black flex flex-col items-center w-[190px] h-[400px]">
              <p className="font-bold text-lg mb-2">Win</p>
              <img
                  src="https://uploadthingy.s3.us-west-1.amazonaws.com/6vJnKJ8AUVGEnXgBRiWAH9/prizez-coins-3.png"
                  alt="Coins"
                  className="w-16 h-16 mb-3"
              />
            ...
            <div className="bg-white rounded-xl p-4 text-black flex flex-col items-center w-[190px] h-[400px]">
              <p className="font-bold text-lg mb-2">Win</p>
              <img
                  src="https://uploadthingy.s3.us-west-1.amazonaws.com/ofQaY3MrbupDhcPiD5MFSJ/prizez-coins-4.png"
                  alt="Coins"
                  className="w-16 h-16 mb-3"
              />
