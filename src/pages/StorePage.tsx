                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-16 gap-4 mb-0">
                        {displayPackages.map((pkg) => (
                            ...
                            >
                              ...
                              <div
                                  className={`relative rounded-xl overflow-hidden flex flex-col h-[330px] bg-white ${pkg.bestValue ? 'gradient-overlay pt-0 border-b-2 border-l-2 border-r-2 border-[#8CDF4F]' : ''}`}
                              >
                                {/* Card Title */}
                                <div
                                    className={
