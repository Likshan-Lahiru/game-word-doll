      ...
      <div className="flex flex-col w-full min-h-screen bg-[#1F2937] text-white p-4">
        ...
        <div className="flex-1 flex flex-col items-center justify-center">
          <div className="bg-gray-800 rounded-3xl p-8 w-full max-w-md">
            <h2 className="text-2xl font-bold text-center mb-6">Time's Up!</h2>
            {/* Lost points */}
            ...
            <p className="text-2xl text-center mb-8">Better Luck Next Time</p>
