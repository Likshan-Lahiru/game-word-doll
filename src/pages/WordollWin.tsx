...
export function WordollWin() {
  const navigate = useNavigate()
  const [showCongratsModal, setShowCongratsModal] = useState(true)
  return (
      <div className="flex flex-col w-full min-h-screen bg-[#1F2937] text-white p-4">
        {/* Back button */}
        <button
        ...
        <div className="flex-1 flex flex-col items-center justify-center">
          <div className="bg-gray-800 rounded-3xl p-8 w-full max-w-md">
            <h2 className="text-2xl font-bold text-center mb-6">Word Guessed!</h2>
            {/* Reward amount */}
            ...
            <p className="text-2xl text-center mb-8">AMAZING!</p>
            ...
            {/* No thanks button */}
            <button
                className="w-full bg-gray-700 hover:bg-gray-600 rounded-full py-3 text-white font-bold"
                onClick={() => navigate('/')}
            >
              No, Thanks
            </button>
