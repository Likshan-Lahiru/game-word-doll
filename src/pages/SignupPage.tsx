...
export function SignupPage() {
  ...
  return <div className="flex flex-col w-full min-h-screen bg-[#1F2937] text-white">
      <div className="p-4">
        <button className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center" onClick={() => navigate(-1)}>
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <form onSubmit={handleSignup} className="space-y-4">
            <input type="text" placeholder="User Name" className="w-full px-4 py-3 bg-[#374151] rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" value={username} onChange={e => setUsername(e.target.value)} required />
            ...
            <input type="text" placeholder="Country" className="w-full px-4 py-3 bg-[#374151] rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" value={country} onChange={e => setCountry(e.target.value)} required />
